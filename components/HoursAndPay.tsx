                      ...
                      return (
                        <div key={log.id} className="grid grid-cols-4 p-6 text-base hover:bg-white/5 transition-colors items-center">
                          ...
                          <div className="text-right">
                            {log.edits.length > 0 ? (
                              <span className="text-[10px] bg-neutral-800 text-orange-400 px-2 py-1 rounded border border-neutral-700 font-bold uppercase tracking-wider">
                                Aangepast
                              </span>
                            ) : (
                               <span className="text-neutral-700 text-xs">OK</span>
                            )}
                          </div>
                        </div>
                      )
