...
import { UserPlus, UserMinus, AlertTriangle, Save, X, History, FileText, AlertCircle } from 'lucide-react';
...
export const Admin: React.FC<AdminProps> = ({ employees, logs, onAddEmployee, onRemoveEmployee, onEditLog }) => {
  const [activeTab, setActiveTab] = useState<'staff' | 'logs' | 'audit'>('staff');
  ...
  return (
    <div className="space-y-6 relative">
      ...
      <header className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
         ...
         <div className="flex gap-2 bg-neutral-900 p-2 rounded-xl border border-neutral-800 self-start md:self-auto w-full md:w-auto overflow-x-auto">
           <button 
